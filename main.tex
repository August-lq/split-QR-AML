...
% \bibitem[Abłamowicz(2020)]{Abłamowicz2020}  
% R. Abłamowicz, \textit{The Moore–Penrose inverse and singular value decomposition of split quaternions},  
% *Adv. Appl. Clifford Algebr.* **30** (2020) 1–20.  

% \bibitem[Alagöz et al.(2012)]{Alagoz2012}  
% Y. Alagöz, K. Oral, S. Yüce, \textit{Split quaternion matrices},  
% *Miskolc Math. Notes* **13**(2) (2012).  

% \bibitem[Cockle(1849)]{Cockle1849}  
% J. Cockle, \textit{LII. On systems of algebra involving more than one imaginary; and on equations of the fifth degree},  
% *London, Edinburgh, Dublin Philos. Mag. J. Sci.* **35**(238) (1849) 434–437.  

% \bibitem[Gogberashvili(2022)]{Gogberashvili2022}  
% M. Gogberashvili, \textit{(2+1)-Maxwell equations in split quaternions},  
% *Physics* **4**(1) (2022) 329–363.  

% \bibitem[Hasebe(2010)]{Hasebe2010}  
% K. Hasebe, \textit{Split-quaternionic Hopf map, quantum Hall effect, and twistor theory},  
% *Phys. Rev. D—Particles, Fields, Gravitation, and Cosmology* **81**(4) (2010) 041702.  

% \bibitem[Jiang et al.(2015)]{Jiang2015}  
% T. Jiang, Z. Jiang, Z. Zhang, \textit{Algebraic techniques for diagonalization of a split quaternion matrix in split quaternionic mechanics},  
% *J. Math. Phys.* **56**(8) (2015).  

% \bibitem[Jiang et al.(2018a)]{Jiang2018a}  
% T. Jiang, Z. Zhang, Z. Jiang, \textit{Algebraic techniques for eigenvalues and eigenvectors of a split quaternion matrix in split quaternionic mechanics},  
% *Comput. Phys. Commun.* **229** (2018) 1–7.  

% \bibitem[Jiang et al.(2018b)]{Jiang2018b}  
% T. Jiang, Z. Zhang, Z. Jiang, \textit{Algebraic techniques for Schrödinger equations in split quaternionic mechanics},  
% *Computers \& Mathematics with Applications* **75**(7) (2018) 2217–2222.  

% \bibitem[Legrand]{Legrand}  
% E. B. Legrand, \textit{The Geometry of Dissipative Mechanical Systems}.  

% \bibitem[Liu and He(2020)]{Liu2020a}  
% X. Liu, Z.-H. He, \textit{On the split quaternion matrix equation $AX = B$},  
% *Banach J. Math. Anal.* **14**(1) (2020) 228–248.  

% \bibitem[Liu and Zhang(2020)]{Liu2020b}  
% X. Liu, Y. Zhang, \textit{Least squares $X = {X^{\eta}}^*$ solutions to split quaternion matrix equation $AX{A^{\eta}}^* = B$},  
% *Math. Methods Appl. Sci.* **43**(5) (2020) 2189–2201.  

% \bibitem[Liu and Zhang(2019)]{Liu2019}  
% X. Liu, Y. Zhang, \textit{Consistency of Split Quaternion Matrix Equations $AX^* - XB = CY + D$ and $X - AX^*B = CY + D$},  
% *Adv. Appl. Clifford Algebr.* **29** (2019) 1–20.  

% \bibitem[Özdemir(2022)]{Ozdemir2022}  
% Z. Özdemir, \textit{A kinematic model of the Rytov’s law in the optical fiber via split quaternions: application to electromagnetic theory},  
% *Eur. Phys. J. Plus* **137**(6) (2022) 651.  

% \bibitem[Öztürk and Özdemir(2023)]{Ozturk2023}  
% İ. Öztürk, M. Özdemir, \textit{On geometric interpretations of split quaternions},  
% *Math. Methods Appl. Sci.* **46**(1) (2023) 408–422.  

% \bibitem[Si et al.(2024)]{Si2024}  
% K.-W. Si, Q.-W. Wang, L.-M. Xie, \textit{A classical system of matrix equations over the split quaternion algebra},  
% *Adv. Appl. Clifford Algebr.* **34**(5) (2024) 51.  

% \bibitem[Wang et al.(2023)]{Wang2023}  
% G. Wang, et al., \textit{An efficient method for Maxwell’s equations with a discrete double-curl operator in split quaternionic electromagnetics},  
% *Eur. Phys. J. Plus* **138**(4) (2023) 341.  

% \bibitem[Wang et al.(2021)]{Wang2021}  
% G. Wang, et al., \textit{A complex structure-preserving algorithm for split quaternion matrix LDU decomposition in split quaternion mechanics},  
% *Calcolo* **58** (2021) 1–15.  

% \bibitem[Wang et al.(2024)]{Wang2024}  
% G. Wang, et al., \textit{On singular value decomposition for split quaternion matrices and applications in split quaternionic mechanics},  
% *J. Comput. Appl. Math.* **436** (2024) 115447.  

% \bibitem[Yuan et al.(2017)]{Yuan2017}  
% S.-F. Yuan, et al., \textit{On Hermitian solutions of the split quaternion matrix equation $AXB + CXD = E$},  
% *Adv. Appl. Clifford Algebr.* **27** (2017) 3235–3252.  

% \bibitem[Zhang et al.(2015)]{Zhang2015}  
% Z. Zhang, Z. Jiang, T. Jiang, \textit{Algebraic methods for least squares problem in split quaternionic mechanics},  
% *Appl. Math. Comput.* **269** (2015) 618–625.

% \bibitem[Abłamowicz(2020)]{Abłamowicz2020} R. Abłamowicz, The Moore–Penrose inverse and singular value decomposition of split quaternions, Adv. Appl. Clifford Algebr. 30 (2020) 1–20.  
% % \bibitem[Abłamowicz(2020)]{Abłamowicz2020} R. Abłamowicz, \textit{The Moore–Penrose inverse and singular value decomposition of split quaternions}, Adv. Appl. Clifford Algebr. 30 (2020) 1–20.  
% \bibitem[Alagöz(2012)]{Alagoz2012} Y. Alagöz, K. Oral, S. Yüce, Split quaternion matrices, Miskolc Math. Notes 13(2) (2012) 223–232.  
...
% \bibitem[Gogberashvili(2022)]{Gog2022} M. Gogberashvili, (2+1)-Maxwell equations in split quaternions, Physics 4(1) (2022) 329–363.  
...
% \bibitem[Jiang(2015)]{Jiang2015} T. Jiang, Z. Jiang, Z. Zhang, Algebraic techniques for diagonalization of a split quaternion matrix in split quaternionic mechanics, J. Math. Phys. 56(8) (2015) 083509.  

% \bibitem[Jiang(2018a)]{Jiang2018a} T. Jiang, Z. Zhang, Z. Jiang, Algebraic techniques for eigenvalues and eigenvectors of a split quaternion matrix in split quaternionic mechanics, Comput. Phys. Comm. 229 (2018) 1–7.  

% \bibitem[Jiang(2018b)]{Jiang2018b} T. Jiang, Z. Zhang, Z. Jiang, Algebraic techniques for Schrödinger equations in split quaternionic mechanics, Comput. Math. Appl. 75(7) (2018) 2217–2222.  

% \bibitem[Legrand(2022)]{Le2022} E. Legrand, The geometry of dissipative mechanical systems: Using Jacobi manifolds and the split quaternion algebra, Delft University of Technology, 2022.  

% \bibitem[Liu and He(2020)]{Liu2020a} X. Liu, Z.-H. He, On the split quaternion matrix equation $AX = B$, Banach J. Math. Anal. 14(1) (2020) 228–248.  

% \bibitem[Liu and Zhang(2020)]{Liu2020b} X. Liu, Y. Zhang, Least squares $X = {X^{\eta}}^*$ solutions to split quaternion matrix equation $AX{A^{\eta}}^* = B$, Math. Methods Appl. Sci. 43(5) (2020) 2189–2201.  

% \bibitem[Liu and Zhang(2019)]{Liu2019} X. Liu, Y. Zhang, Consistency of Split Quaternion Matrix Equations $AX^* - XB = CY + D$ and $X - AX^*B = CY + D$, Adv. Appl. Clifford Algebr. 29 (2019) 1–20.  

% \bibitem[Özdemir(2022)]{Ozdemir2022} Z. Özdemir, A kinematic model of the Rytov’s law in the optical fiber via split quaternions: application to electromagnetic theory, Eur. Phys. J. Plus 137(6) (2022) 1–13.  

% \bibitem[Öztürk and Özdemir(2023)]{Ozturk2023} İ. Öztürk, M. Özdemir, On geometric interpretations of split quaternions, Math. Methods Appl. Sci. 46(1) (2023) 408–422.  

% \bibitem[Si et al.(2024)]{Si2024} K.-W. Si, Q.-W. Wang, L.-M. Xie, A classical system of matrix equations over the split quaternion algebra, Adv. Appl. Clifford Algebr. 34(5) (2024) 51.  

% \bibitem[Wang et al.(2023)]{Wang2023} G. Wang, T. Jiang, V.I. Vasil’ev, Z. Guo, An efficient method for Maxwell’s equations with a discrete double-curl operator in split quaternionic electromagnetics, Eur. Phys. J. Plus 138(4) (2023) 341.  

% \bibitem[Wang et al.(2021)]{Wang2021} G. Wang, T. Jiang, Z. Guo, D. Zhang, A complex structure-preserving algorithm for split quaternion matrix LDU decomposition in split quaternion mechanics, Calcolo 58(34) (2021) 1–15.  

% \bibitem[Wang et al.(2024)]{Wang2024} G. Wang, T. Jiang, V. Vasil’ev, Z. Guo, On singular value decomposition for split quaternion matrices and applications in split quaternionic mechanics, J. Comput. Appl. Math. 436 (2024) 115447.  

% \bibitem[Yuan et al.(2017)]{Yuan2017} S.-F. Yuan, Q.-W. Wang, Y. Yu, On Hermitian solutions of the split quaternion matrix equation $AXB + CXD = E$, Adv. Appl. Clifford Algebr. 27 (2017) 3235–3252.  

% \bibitem[Zhang et al.(2015)]{Zhang2015} Z. Zhang, Z. Jiang, T. Jiang, Algebraic methods for least squares problem in split quaternionic mechanics, Appl. Math. Comput. 269 (2015) 618–625.
...
\bibitem{Yasemin2012} \iffalse Yasemin Alag\"oz, Kh\"ursat Hakan Oral, and Salim Y\"uce.\fi Y. Alag\"oz, K. Oral, and S. Y\"uce. "Split quaternion matrices." Miskolc Mathematical Notes 13.2 (2012) 223–232.
...
\bibitem{Xin2019} X. Liu and Y. Zhang. Consistency of Split Quaternion Matrix Equations $AX^* - XB = CY + D$ and $X - AX^*B = CY + D$. Advances in Applied Clifford Algebras 29 (2019): 1-20.


\bibitem{Yang2020} X. Liu and Y. Zhang. Least squares \(X = {X^{\eta}}^* \) solutions to split quaternion matrix equation \(AX{A^{\eta}}^*= B\). Mathematical Methods in the Applied Sciences 43.5 (2020): 2189-2201.
...
\bibitem{Abłamowicz2020} R. Abłamowicz, The Moore–Penrose inverse and singular value decomposition of split quaternions, Adv. Appl. Clifford Algebr. 33 (30) (2020)1–20.
 ...
 \bibitem{Zhang2015}Z. Zhang, Z. Jiang, T. Jiang, Algebraic methods for least squares problem in split quaternionic mechanics, Applied Mathematics and Computation 269 (2015): 618-625.
...
\bibitem{Gang2024}G. Wang, T. Jiang, V. Vasil’ev, and Z. Guo. On singular value decomposition for split quaternion matrices and applications in split quaternionic mechanics. Journal of Computational and Applied Mathematics 436 (2024): 115447.
